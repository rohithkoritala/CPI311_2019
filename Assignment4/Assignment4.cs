...
namespace Assignment4
{
    ...
    public class Assignment4 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            ship.Model = Content.Load<Model>("p1_wedge1");
                    ...
                    for (int j = 0; j < bulletList.Length; j++)
                    {
                        if (bulletList[j].isActive)
                        {
                            ...
                            if (asteroidSphere.Intersects(bulletSphere))
                            {
                                ...
                                bulletList[j].isActive = false;
                                break; //noáneedátoácheckáotherábulletsá
                            }
                        }
                    }
                }
        ...
        protected void UpdateInput()
        {
            ...
            //    ship.Update(gameTime);
                ...
                // In case you get lost, press Z to warp back to the center.
            ...
            //are we shooting?
            if (ship.isActive && InputManager.IsKeyDown(Keys.Space))
            {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.DrawString(font, "Score: " + score, scorePosition, Color.LightGreen);
            spriteBatch.End();
